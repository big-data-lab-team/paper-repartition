...
\begin{figure}
  ...
  \caption{Division of a read block into write blocks. Write blocks are merged using the scheme in Table~\ref{tab:fusion}. The blue block represents $F_0$ \tristan{sure but what is F0, how is it defined? }.}
