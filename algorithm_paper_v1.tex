...
algorithms are ``necessary when data cannot be entirely loaded in memory". \tristan{last sentence is redundant with last part of previous one.}
...
scientific community and it is written in \texttt{C-order} by default. \tristan{Eventually this paragraph should be moved to the first place where we need this.}
...
the execution of the keep algorithm. \write{To estimate this amount, we first need to
