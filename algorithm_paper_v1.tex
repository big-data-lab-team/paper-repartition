...
contigous in its output file of destination is called \texttt{extra data}.
...
cache. In the following paragraphs we explain how to find the optimal buffer
shape for the keep strategy.
...
such an order is the storage order because in the case of a row-major ordering such
an order would keep extra data in the $k$ dimension first. An analysis of the
