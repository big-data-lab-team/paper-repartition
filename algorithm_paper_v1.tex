...
\begin{table}[ht]
 ...
 \caption{Experiment 3.1}
  ...
  \hline
    I & O & $I<O$ \\
    \hline\hline
    (780,600,700) & (650,500,500) & False \\
    \hline
    (780,600,700) & (975,1000,875) & True \\
    \hline
    (390,300,350) & (325,250,250) & False  \\
    \hline
    (390,300,350) & (650,500,700) & True \\
    \hline
    (195,150,175) & (300,250,250) & True \\
    \hline
    (195,150,175) & (650,375,500) & True \\
    \hline
    (650,375,500) & (390,300,350) & False \\
    \hline
    (650,375,500) & (975,600,700) & True \\
    \hline
  \end{tabular}
...
\begin{figure*}
  \centering
  \includegraphics[scale=0.5]{./figures/exp2_results_blocks.png}
  \label{fig:exp2_block}
  \caption{Experiment 2 on blocks}
\end{figure*}

\begin{figure*}
  \centering
  \includegraphics[scale=0.5]{./figures/exp2_results_slabs.png}
  \label{fig:exp2_slabs}
  \caption{Experiment 2 on slabs}
\end{figure*}
...
\begin{figure*}
  \centering
  \includegraphics[scale=0.4]{./figures/exp5_1_results.png}
  \label{fig:exp3_1}
  \caption{Experiment 3.1}
